...
const og = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630">
  <defs>
    <radialGradient id="glow" cx="50%" cy="0%" r="80%">
      <stop offset="0%" stop-color="#ff5024" stop-opacity="0.14"/>
      <stop offset="60%" stop-color="#ff5024" stop-opacity="0"/>
    </radialGradient>
  ...
  <rect x="80" y="96" width="26" height="4" rx="2" fill="#ff5024"/>
  ...
  <text x="76" y="380" font-family="Segoe UI, Arial, sans-serif" font-weight="700" font-size="104" letter-spacing="-3" fill="#ff5024">Galerani</text>
  <text x="80" y="460" font-family="Segoe UI, Arial, sans-serif" font-size="34" fill="#aaa49c">Offensive Security · AppSec · SIEM · 50+ certificações</text>
  <text x="80" y="552" font-family="Consolas, monospace" font-size="26" fill="#736d64">❯ pablodlz.github.io/portfolio<tspan fill="#ff5024">_</tspan></text>
</svg>`;
